//+------------------------------------------------------------------+
//|                                                         test.mq4 |
//|                                          Copyright 2017, NextCom |
//|                                                http://froid.tech |
//+------------------------------------------------------------------+
#property copyright "Copyright 2017, NextCom"
#property link      "http://froid.tech"
...
void OnStart()
  {
  Alert("StochKperiod: ",Eq_StochKPeriod());
  Alert("StochDperiod: ", Eq_StochDPeriod());
  Alert("StockSlowing: ",Eq_StochSlowing());
  Alert("RSIPeriod: ",Eq_RSIPeriod());
  Alert("RSILEvel: ", Eq_RSILevel());
  Alert("AdxPeriod: ", Eq_ADXPeriod()); 
  Alert("BearsPeriod: ", Eq_BearsPeriod());
  Alert("BullsPeriod: ", Eq_BullsPeriod());
  Alert("Rperiod: ", Eq_Rperiod());
  Alert("BBPeriod: ", Eq_BBPeriod());
  Alert("MacdFast: ", Eq_MACDFast());
  Alert("MACDSlow: ", Eq_MACDSlow());
  Alert("MacdSMA: ", Eq_MACDSMA());  
    Alert("Margin Pips: ", Eq_MarginPips());
    Alert("Take profit: ", Eq_TakeProfit());
    Alert(" Magic1 :", Eq_Magic1());
    Alert("Magic2 :", Eq_Magic2());
    Alert("Expiration: ", Eq_Expiration());
       ...
       y = a0 + a1*cos(x*w) + b1*sin(x*w) + a2*cos(2*x*w) + b2*sin(2*x*w)
        + a3*cos(3*x*w) + b3*sin(3*x*w) +  a4*cos(4*x*w) + b4*sin(4*x*w)
         + a5*cos(5*x*w) + b5*sin(5*x*w) + a6*cos(6*x*w) + b6*sin(6*x*w)
          + a7*cos(7*x*w) + b7*sin(7*x*w) + a8*cos(8*x*w) + b8*sin(8*x*w);
       return y;
...
int Eq_StochDPeriod(){
     ...
     x = DayOfYear();
       ...
       y = a0 + a1*cos(x*w) + b1*sin(x*w) + a2*cos(2*x*w) +
        b2*sin(2*x*w) + a3*cos(3*x*w) + b3*sin(3*x*w) +  
        a4*cos(4*x*w) + b4*sin(4*x*w) + a5*cos(5*x*w) + 
...
// RMSE: 15.04
     ...
     x = DayOfYear();
       ...
       y =  a0 + a1*cos(x*w) + b1*sin(x*w) + a2*cos(2*x*w) + 
       b2*sin(2*x*w) + a3*cos(3*x*w) + b3*sin(3*x*w) + a4*cos(4*x*w) +
        b4*sin(4*x*w) + a5*cos(5*x*w) + b5*sin(5*x*w) + a6*cos(6*x*w) +
         b6*sin(6*x*w) + a7*cos(7*x*w) + b7*sin(7*x*w);
